<x-app-layout>
    ...
    <form action="/projects"
        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" class="border border-gray-400 p-2 text-xs block w-full rounded">
                </div>

                <div class="mb-4">
                    <label for="description" class="text-sm block mb-2">Description</label>
                    <textarea id="description" class="border border-gray-400 p-2 text-xs block w-full rounded" rows="7"></textarea>
                </div>
            </div>

            <div class="flex-1 ml-4">
                <div class="mb-4">
                    <label for="tasks" class="text-sm block mb-2">Need Some Tasks?</label>
                    <input type="text" class="border border-gray-400 p-2 text-xs block w-full rounded" placeholder="Task 1">
                </div>
        ...
        <footer class="flex justify-end">
            <button class="button mr-4 bg-white border border-blue-400 text-blue-400">Cancel</button>
